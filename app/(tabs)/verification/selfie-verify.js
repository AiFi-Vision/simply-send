...
const SelfieVerifyScreen = () => {
  ...
  const handleVerify = () => {
    useUserStore.getState().setUser({ selfieVerify: true });
  ...
  return (
    <ContainerView
      title="Verify Selfie Capture"
      content="Please verify your selfie image is clear, with no glare and centered within the frame. Failure to do this could result in a failed verification capture and will need a resubmission"
      footer={
